...
class TAdresse:
    ...
    :ivar ban_id: clé d'intéropérabilité de la BAN referençant
        l'adresse. (id dans l'API adresse d'etalab). Attention Il ne
        s'agit pas de l'identifiant BAN stable (banId)
    :ivar ban_id_ban_adresse: identifant BAN stable officiel de
        l'adresse. Le nom du champs est celui du format BAL 1.4 (
        https://aitf-sig-topo.github.io/voies-
        adresses/files/AITF_SIG_Topo_Format_Base_Adresse_Locale_v1.4.pdf
        ) (ce champs s'appelle banId dans l'API adresse d'etalab)
    ...
    ban_id_ban_adresse: Optional[str] = field(
        default=None,
        metadata={
            "type": "Element",
            "max_length": 255,
...
class Administratif:
    ...
    :ivar consentement_proprietaire: A partir du 1er juillet 2024, lors
        de toutes ses interventions, le diagnostiqueur recueille le
        consentement de ses clients en vue de la transmission de leurs
        coordonnées à l’organisme de certification à des fins de
        contrôles, selon un modèle de formulaire fourni par les services
        du ministère chargé de la construction.
    :ivar information_consentement_proprietaire:
    """
    ...
    consentement_proprietaire: Optional[SOuiNon] = field(
        default=None,
        metadata={
            "type": "Element",
            "nillable": True,
    ...
    information_consentement_proprietaire: Optional[
        "Administratif.InformationConsentementProprietaire"
    ] = field(
        default=None,
        metadata={
            "type": "Element",
    ...
    @dataclass
    class InformationConsentementProprietaire:
        """
        :ivar nom_proprietaire: denomination ou raison sociale du
            propriétaire
        :ivar personne_morale: le propriétaire est-il une personne
            morale
        :ivar siren_proprietaire: siren du propriétaire, saisie
            obligatoire lorsqu'il s'agit d'une personne morale.
        :ivar telephone: numéro de téléphone du propriétaire
        :ivar mail: adresse mail du proprietaire
        :ivar label_adresse: libellé complet de l'adresse postale du
            bien saisi par le diagnostiqueur (FORMAT ATTENDU : Numéro de
            l’adresse dans la voie + Indice de répétition associé au
            numéro (par exemple bis, a…) + Nom de la voie en minuscules
            accentuées + Code postal du bureau de distribution de la
            voie + Nom officiel de la commune actuelle
        :ivar label_adresse_avec_complement: libellé complet d'adresse
            complète qui est l'adresse postale du bien précédé par
            l'ensemble des compléments d'adresses nécessaires à la bonne
            localisation du bien saisi par le diagnostiqueur (FORMAT
            ATTENDU : Compléments d'adresses + Numéro de l’adresse dans
            la voie + Indice de répétition associé au numéro (par
        ...
        personne_morale: Optional[SOuiNon] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        label_adresse: Optional[str] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        label_adresse_avec_complement: Optional[str] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
...
@dataclass
class Dpe:
    """Version V8.2.0 - 2024-05-20 : arrêté petite surface et obligation consentement proprietaire
    ...
    class Tertiaire:
        ...
        class CaracteristiqueGenerale:
            ...
            :ivar enum_sous_modele_dpe_ter_id: sous modèle de DPE
                tertiaire correspondant aux catégories en vigueur
                (https://rt-re-batiment.developpement-
                durable.gouv.fr/dpe-tertiaire-r378.html)
            ...
            enum_sous_modele_dpe_ter_id: Optional[int] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "min_inclusive": 1,
